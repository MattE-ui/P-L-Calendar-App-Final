...
function computeTradeRealizedPnlGBP(trade) {
  ...
  if (totalEntered <= 0 || totalExited <= 0) return null;
  ...
  // Only return a value if the trade currency is GBP (or unset); non-GBP
  // trades need live FX rates which are unavailable at sync time.
