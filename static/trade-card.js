...
const TRADE_CARD_LAYOUTS = {
  ...
  portrait: {
    ...
    rValue: { x: 300, y: 350, fontSize: 60, fontWeight: 700, color: TRADE_CARD_COLORS.positive, align: 'left' },
    rLabel: { x: 300, y: 380, fontSize: 22, fontWeight: 600, color: TRADE_CARD_COLORS.label, align: 'left' },
    entryLabel: { x: 150, y: 500, fontSize: 24, fontWeight: 600, color: TRADE_CARD_COLORS.label, align: 'left' },
    entryValue: { x: 150, y: 450, fontSize: 32, fontWeight: 700, color: TRADE_CARD_COLORS.text, align: 'left' },
    stopLabel: { x: 300, y: 500, fontSize: 24, fontWeight: 600, color: TRADE_CARD_COLORS.label, align: 'left' },
    stopValue: { x: 300, y: 450, fontSize: 32, fontWeight: 700, color: TRADE_CARD_COLORS.text, align: 'left' },
    entryDateLabel: { x: 140, y: 700, fontSize: 24, fontWeight: 600, color: TRADE_CARD_COLORS.label, align: 'left' },
    entryDateValue: { x: 140, y: 600, fontSize: 32, fontWeight: 700, color: TRADE_CARD_COLORS.text, align: 'left' },
    closeDateLabel: { x: 300, y: 700, fontSize: 24, fontWeight: 600, color: TRADE_CARD_COLORS.label, align: 'left' },
    closeDateValue: { x: 300, y: 600, fontSize: 32, fontWeight: 700, color: TRADE_CARD_COLORS.text, align: 'left' },
    directionPill: { x: 355, y: 220, height: 28 },
    footerLeft: { x: 250, y: 1100, fontSize: 26, fontWeight: 600, color: '#000000', align: 'left' },
    footerRight: { x: 300, y: 1200, fontSize: 24, fontWeight: 500, color: '#000000', align: 'right' },
