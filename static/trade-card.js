...
const TRADE_CARD_LAYOUTS = {
  ...
  portrait: {
    ...
    rValue: { x: 330, y: 350, fontSize: 60, fontWeight: 700, color: TRADE_CARD_COLORS.positive, align: 'left' },
    rLabel: { x: 330, y: 380, fontSize: 22, fontWeight: 600, color: TRADE_CARD_COLORS.label, align: 'left' },
    ...
    stopValue: { x: 400, y: 450, fontSize: 32, fontWeight: 700, color: TRADE_CARD_COLORS.text, align: 'left' },
    entryDateLabel: { x: 140, y: 650, fontSize: 24, fontWeight: 600, color: TRADE_CARD_COLORS.label, align: 'left' },
    entryDateValue: { x: 140, y: 5500, fontSize: 32, fontWeight: 700, color: TRADE_CARD_COLORS.text, align: 'left' },
    closeDateLabel: { x: 400, y: 650, fontSize: 24, fontWeight: 600, color: TRADE_CARD_COLORS.label, align: 'left' },
    closeDateValue: { x: 400, y: 550, fontSize: 32, fontWeight: 700, color: TRADE_CARD_COLORS.text, align: 'left' },
