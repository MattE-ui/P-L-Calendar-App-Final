...
const TRADE_CARD_LAYOUTS = {
  ...
  portrait: {
    ...
    rValue: { x: 665, y: 350, fontSize: 60, fontWeight: 700, color: TRADE_CARD_COLORS.positive, align: 'left' },
    rLabel: { x: 665, y: 380, fontSize: 22, fontWeight: 600, color: TRADE_CARD_COLORS.label, align: 'left' },
    entryLabel: { x: 75, y: 500, fontSize: 24, fontWeight: 600, color: TRADE_CARD_COLORS.label, align: 'left' },
    entryValue: { x: 75, y: 450, fontSize: 32, fontWeight: 700, color: TRADE_CARD_COLORS.text, align: 'left' },
    ...
    footerLeft: { x: 140, y: 1000, fontSize: 26, fontWeight: 600, color: '#000000', align: 'left' },
    footerRight: { x: 900, y: 1000, fontSize: 24, fontWeight: 500, color: '#000000', align: 'right' },
