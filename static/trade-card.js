...
const TRADE_CARD_LAYOUTS = {
  ...
  portrait: {
    ...
    rValue: { x: 590, y: 350, fontSize: 60, fontWeight: 700, color: TRADE_CARD_COLORS.positive, align: 'left' },
    rLabel: { x: 590, y: 380, fontSize: 22, fontWeight: 600, color: TRADE_CARD_COLORS.label, align: 'left' },
    ...
    stopLabel: { x: 665, y: 500, fontSize: 24, fontWeight: 600, color: TRADE_CARD_COLORS.label, align: 'left' },
    stopValue: { x: 665, y: 450, fontSize: 32, fontWeight: 700, color: TRADE_CARD_COLORS.text, align: 'left' },
    ...
    closeDateLabel: { x: 600, y: 700, fontSize: 24, fontWeight: 600, color: TRADE_CARD_COLORS.label, align: 'left' },
    closeDateValue: { x: 600, y: 600, fontSize: 32, fontWeight: 700, color: TRADE_CARD_COLORS.text, align: 'left' },
    directionPill: { x: 355, y: 220, height: 28 },
    footerLeft: { x: 75, y: 1200, fontSize: 26, fontWeight: 600, color: '#000000', align: 'left' },
    footerRight: { x: 600, y: 1200, fontSize: 24, fontWeight: 500, color: '#000000', align: 'right' },
