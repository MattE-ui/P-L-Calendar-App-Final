...
const TRADE_CARD_LAYOUTS = {
  ...
  portrait: {
    ...
    entryDateLabel: { x: 140, y: 600, fontSize: 24, fontWeight: 600, color: TRADE_CARD_COLORS.label, align: 'left' },
    entryDateValue: { x: 140, y: 575, fontSize: 32, fontWeight: 700, color: TRADE_CARD_COLORS.text, align: 'left' },
    closeDateLabel: { x: 400, y: 600, fontSize: 24, fontWeight: 600, color: TRADE_CARD_COLORS.label, align: 'left' },
    closeDateValue: { x: 400, y: 575, fontSize: 32, fontWeight: 700, color: TRADE_CARD_COLORS.text, align: 'left' },
